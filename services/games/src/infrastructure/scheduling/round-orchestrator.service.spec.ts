...
import { GameBroadcaster } from '../websocket/game.gateway.interface';
...
interface OrchestratorCtx {
  state: { rounds: Round[]; bets: Bet[]; published: Array<{ eventType: string; payload: any }> };
  rounds: any;
  bets: any;
...
const buildOrchestrator = (ctx: OrchestratorCtx, broadcaster: GameBroadcaster) =>
